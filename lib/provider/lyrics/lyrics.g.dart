...
class _LyricsProviderElement
    extends AutoDisposeFutureProviderElement<SubsonicResponse?> with LyricsRef {
...
class LyricsOfLineFamily extends Family<String> {
  ...
  /// See also [lyricsOfLine].
  LyricsOfLineProvider call(
    SubsonicResponse lyrics,
    Duration position,
  ) {
    return LyricsOfLineProvider(
      lyrics,
      position,
    );
  }
...
class LyricsOfLineProvider extends AutoDisposeProvider<String> {
  /// See also [lyricsOfLine].
  LyricsOfLineProvider(
    SubsonicResponse lyrics,
    Duration position,
  ) : this._internal(
          (ref) => lyricsOfLine(
            ref as LyricsOfLineRef,
            lyrics,
            position,
          ),
  ...
  @override
  Override overrideWith(
    String Function(LyricsOfLineRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
