...
class SongDetailFamily extends Family<AsyncValue<SubsonicResponse?>> {
  ...
  /// See also [songDetail].
  SongDetailProvider call(
    String? songId,
  ) {
    return SongDetailProvider(
      songId,
    );
  }
  ...
  SongDetailProvider(
    String? songId,
          ...
          allTransitiveDependencies:
              SongDetailFamily._allTransitiveDependencies,
          songId: songId,
        );
...
final songFavoriteProvider =
  ...
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$songFavoriteHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
final songRatingProvider =
  ...
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$songRatingHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
