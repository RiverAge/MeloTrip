...
_$AlbumEntityImpl _$$AlbumEntityImplFromJson(Map<String, dynamic> json) =>
    _$AlbumEntityImpl(
...
Map<String, dynamic> _$$AlbumEntityImplToJson(_$AlbumEntityImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
_$DiscTitleImpl _$$DiscTitleImplFromJson(Map<String, dynamic> json) =>
    _$DiscTitleImpl(
      disc: (json['disc'] as num?)?.toInt(),
      title: json['title'] as String?,
    );

Map<String, dynamic> _$$DiscTitleImplToJson(_$DiscTitleImpl instance) =>
    <String, dynamic>{
      'disc': instance.disc,
...
_$AlbumListEntityImpl _$$AlbumListEntityImplFromJson(
...
Map<String, dynamic> _$$AlbumListEntityImplToJson(
        _$AlbumListEntityImpl instance) =>
    <String, dynamic>{
