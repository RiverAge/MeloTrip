...
_SubsonicResponseClass _$SubsonicResponseClassFromJson(
  ...
  randomSongs: json['randomSongs'] == null
      ? null
      : RandomSongsEntity.fromJson(json['randomSongs'] as Map<String, dynamic>),
  song: json['song'] == null
      ? null
  ...
  lyricsList: json['lyricsList'] == null
      ? null
      : LyricsListEntity.fromJson(json['lyricsList'] as Map<String, dynamic>),
  scanStatus: json['scanStatus'] == null
      ? null
      : ScanStatusEntity.fromJson(json['scanStatus'] as Map<String, dynamic>),
  ...
  artists: json['artists'] == null
      ? null
      : ArtistsEntity.fromJson(json['artists'] as Map<String, dynamic>),
  indexes: json['indexes'] == null
      ? null
      : IndexesEntity.fromJson(json['indexes'] as Map<String, dynamic>),
  directory: json['directory'] == null
      ? null
      : DirectoryEntity.fromJson(json['directory'] as Map<String, dynamic>),
