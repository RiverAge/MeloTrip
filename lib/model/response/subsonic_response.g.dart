...
_$SubsonicResponseImpl _$$SubsonicResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$SubsonicResponseImpl(
...
Map<String, dynamic> _$$SubsonicResponseImplToJson(
        _$SubsonicResponseImpl instance) =>
    <String, dynamic>{
      'subsonic-response': instance.subsonicResponse,
    };

_$SubsonicResponseClassImpl _$$SubsonicResponseClassImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$SubsonicResponseClassImplToJson(
        _$SubsonicResponseClassImpl instance) =>
    <String, dynamic>{
