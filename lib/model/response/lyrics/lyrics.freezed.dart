...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? displayArtist,  String? displayTitle,  String? lang, @LinesConvert()  List<Line>? line,  int? offset,  bool? synced)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StructuredLyric() when $default != null:
return $default(_that.displayArtist,_that.displayTitle,_that.lang,_that.line,_that.offset,_that.synced);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? displayArtist,  String? displayTitle,  String? lang, @LinesConvert()  List<Line>? line,  int? offset,  bool? synced)  $default,) {final _that = this;
switch (_that) {
case _StructuredLyric():
return $default(_that.displayArtist,_that.displayTitle,_that.lang,_that.line,_that.offset,_that.synced);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? displayArtist,  String? displayTitle,  String? lang, @LinesConvert()  List<Line>? line,  int? offset,  bool? synced)?  $default,) {final _that = this;
switch (_that) {
case _StructuredLyric() when $default != null:
return $default(_that.displayArtist,_that.displayTitle,_that.lang,_that.line,_that.offset,_that.synced);case _:
  return null;
