...
_$GenreElementImpl _$$GenreElementImplFromJson(Map<String, dynamic> json) =>
    _$GenreElementImpl(
      name: json['name'] as String?,
    );

Map<String, dynamic> _$$GenreElementImplToJson(_$GenreElementImpl instance) =>
    <String, dynamic>{
      'name': instance.name,
    };

_$ReplayGainImpl _$$ReplayGainImplFromJson(Map<String, dynamic> json) =>
    _$ReplayGainImpl(
      trackPeak: (json['trackPeak'] as num?)?.toInt(),
      albumPeak: (json['albumPeak'] as num?)?.toInt(),
    );

Map<String, dynamic> _$$ReplayGainImplToJson(_$ReplayGainImpl instance) =>
    <String, dynamic>{
