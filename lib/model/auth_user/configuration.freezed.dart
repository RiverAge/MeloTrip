...
@JsonKey(name: 'username') String? get username;@JsonKey(name: 'max_rate') String? get maxRate;@JsonKey(name: 'playlist_mode') PlaylistMode? get playlistMode;@JsonKey(name: 'shuffle')@SqliteBoolConvert() bool? get shuffle;@JsonKey(name: 'recent_searches') String? get recentSearches;@JsonKey(name: 'desktop_lyrics_config') String? get desktopLyricsConfig;@JsonKey(name: 'recommend_refresh_state') String? get recommendRefreshState; ThemeMode? get theme;@JsonKey(name: 'theme_seed') AppThemeSeed? get themeSeed;@LocaleConvert() Locale? get locale;@JsonKey(name: 'update_at') int? get updateAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Configuration&&(identical(other.username, username) || other.username == username)&&(identical(other.maxRate, maxRate) || other.maxRate == maxRate)&&(identical(other.playlistMode, playlistMode) || other.playlistMode == playlistMode)&&(identical(other.shuffle, shuffle) || other.shuffle == shuffle)&&(identical(other.recentSearches, recentSearches) || other.recentSearches == recentSearches)&&(identical(other.desktopLyricsConfig, desktopLyricsConfig) || other.desktopLyricsConfig == desktopLyricsConfig)&&(identical(other.recommendRefreshState, recommendRefreshState) || other.recommendRefreshState == recommendRefreshState)&&(identical(other.theme, theme) || other.theme == theme)&&(identical(other.themeSeed, themeSeed) || other.themeSeed == themeSeed)&&(identical(other.locale, locale) || other.locale == locale)&&(identical(other.updateAt, updateAt) || other.updateAt == updateAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,username,maxRate,playlistMode,shuffle,recentSearches,desktopLyricsConfig,recommendRefreshState,theme,themeSeed,locale,updateAt);

@override
String toString() {
  return 'Configuration(username: $username, maxRate: $maxRate, playlistMode: $playlistMode, shuffle: $shuffle, recentSearches: $recentSearches, desktopLyricsConfig: $desktopLyricsConfig, recommendRefreshState: $recommendRefreshState, theme: $theme, themeSeed: $themeSeed, locale: $locale, updateAt: $updateAt)';
}
...
@useResult
$Res call({
@JsonKey(name: 'username') String? username,@JsonKey(name: 'max_rate') String? maxRate,@JsonKey(name: 'playlist_mode') PlaylistMode? playlistMode,@JsonKey(name: 'shuffle')@SqliteBoolConvert() bool? shuffle,@JsonKey(name: 'recent_searches') String? recentSearches,@JsonKey(name: 'desktop_lyrics_config') String? desktopLyricsConfig,@JsonKey(name: 'recommend_refresh_state') String? recommendRefreshState, ThemeMode? theme,@JsonKey(name: 'theme_seed') AppThemeSeed? themeSeed,@LocaleConvert() Locale? locale,@JsonKey(name: 'update_at') int? updateAt
});
...
/// Create a copy of Configuration
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = freezed,Object? maxRate = freezed,Object? playlistMode = freezed,Object? shuffle = freezed,Object? recentSearches = freezed,Object? desktopLyricsConfig = freezed,Object? recommendRefreshState = freezed,Object? theme = freezed,Object? themeSeed = freezed,Object? locale = freezed,Object? updateAt = freezed,}) {
...
as PlaylistMode?,shuffle: freezed == shuffle ? _self.shuffle : shuffle // ignore: cast_nullable_to_non_nullable
as bool?,recentSearches: freezed == recentSearches ? _self.recentSearches : recentSearches // ignore: cast_nullable_to_non_nullable
as String?,desktopLyricsConfig: freezed == desktopLyricsConfig ? _self.desktopLyricsConfig : desktopLyricsConfig // ignore: cast_nullable_to_non_nullable
as String?,recommendRefreshState: freezed == recommendRefreshState ? _self.recommendRefreshState : recommendRefreshState // ignore: cast_nullable_to_non_nullable
as String?,theme: freezed == theme ? _self.theme : theme // ignore: cast_nullable_to_non_nullable
as ThemeMode?,themeSeed: freezed == themeSeed ? _self.themeSeed : themeSeed // ignore: cast_nullable_to_non_nullable
as AppThemeSeed?,locale: freezed == locale ? _self.locale : locale // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'username')  String? username, @JsonKey(name: 'max_rate')  String? maxRate, @JsonKey(name: 'playlist_mode')  PlaylistMode? playlistMode, @JsonKey(name: 'shuffle')@SqliteBoolConvert()  bool? shuffle, @JsonKey(name: 'recent_searches')  String? recentSearches, @JsonKey(name: 'desktop_lyrics_config')  String? desktopLyricsConfig, @JsonKey(name: 'recommend_refresh_state')  String? recommendRefreshState,  ThemeMode? theme, @JsonKey(name: 'theme_seed')  AppThemeSeed? themeSeed, @LocaleConvert()  Locale? locale, @JsonKey(name: 'update_at')  int? updateAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Configuration() when $default != null:
return $default(_that.username,_that.maxRate,_that.playlistMode,_that.shuffle,_that.recentSearches,_that.desktopLyricsConfig,_that.recommendRefreshState,_that.theme,_that.themeSeed,_that.locale,_that.updateAt);case _:
  return orElse();
...
@override@JsonKey(name: 'recommend_refresh_state') final  String? recommendRefreshState;
@override final  ThemeMode? theme;
@override@JsonKey(name: 'theme_seed') final  AppThemeSeed? themeSeed;
...
/// Create a copy of Configuration
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = freezed,Object? maxRate = freezed,Object? playlistMode = freezed,Object? shuffle = freezed,Object? recentSearches = freezed,Object? desktopLyricsConfig = freezed,Object? recommendRefreshState = freezed,Object? theme = freezed,Object? themeSeed = freezed,Object? locale = freezed,Object? updateAt = freezed,}) {
