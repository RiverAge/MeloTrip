...
@JsonKey(name: 'username') String? get username;@JsonKey(name: 'max_rate') String? get maxRate;@JsonKey(name: 'playlist_mode') PlaylistMode? get playlistMode;@JsonKey(name: 'recent_searches') String? get recentSearches; ThemeMode? get theme;@LocaleConvert() Locale? get locale;@JsonKey(name: 'update_at') int? get updateAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,username,maxRate,playlistMode,recentSearches,theme,locale,updateAt);

@override
String toString() {
  return 'Configuration(username: $username, maxRate: $maxRate, playlistMode: $playlistMode, recentSearches: $recentSearches, theme: $theme, locale: $locale, updateAt: $updateAt)';
}
...
@useResult
$Res call({
@JsonKey(name: 'username') String? username,@JsonKey(name: 'max_rate') String? maxRate,@JsonKey(name: 'playlist_mode') PlaylistMode? playlistMode,@JsonKey(name: 'recent_searches') String? recentSearches, ThemeMode? theme,@LocaleConvert() Locale? locale,@JsonKey(name: 'update_at') int? updateAt
});
...
/// Create a copy of Configuration
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = freezed,Object? maxRate = freezed,Object? playlistMode = freezed,Object? recentSearches = freezed,Object? theme = freezed,Object? locale = freezed,Object? updateAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'username')  String? username, @JsonKey(name: 'max_rate')  String? maxRate, @JsonKey(name: 'playlist_mode')  PlaylistMode? playlistMode, @JsonKey(name: 'recent_searches')  String? recentSearches,  ThemeMode? theme, @LocaleConvert()  Locale? locale, @JsonKey(name: 'update_at')  int? updateAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Configuration() when $default != null:
return $default(_that.username,_that.maxRate,_that.playlistMode,_that.recentSearches,_that.theme,_that.locale,_that.updateAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'username')  String? username, @JsonKey(name: 'max_rate')  String? maxRate, @JsonKey(name: 'playlist_mode')  PlaylistMode? playlistMode, @JsonKey(name: 'recent_searches')  String? recentSearches,  ThemeMode? theme, @LocaleConvert()  Locale? locale, @JsonKey(name: 'update_at')  int? updateAt)  $default,) {final _that = this;
switch (_that) {
case _Configuration():
return $default(_that.username,_that.maxRate,_that.playlistMode,_that.recentSearches,_that.theme,_that.locale,_that.updateAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'username')  String? username, @JsonKey(name: 'max_rate')  String? maxRate, @JsonKey(name: 'playlist_mode')  PlaylistMode? playlistMode, @JsonKey(name: 'recent_searches')  String? recentSearches,  ThemeMode? theme, @LocaleConvert()  Locale? locale, @JsonKey(name: 'update_at')  int? updateAt)?  $default,) {final _that = this;
switch (_that) {
case _Configuration() when $default != null:
return $default(_that.username,_that.maxRate,_that.playlistMode,_that.recentSearches,_that.theme,_that.locale,_that.updateAt);case _:
  return null;
...
class _Configuration implements Configuration {
  const _Configuration({@JsonKey(name: 'username') this.username, @JsonKey(name: 'max_rate') this.maxRate, @JsonKey(name: 'playlist_mode') this.playlistMode, @JsonKey(name: 'recent_searches') this.recentSearches, this.theme, @LocaleConvert() this.locale, @JsonKey(name: 'update_at') this.updateAt});
...
/// Create a copy of Configuration
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = freezed,Object? maxRate = freezed,Object? playlistMode = freezed,Object? recentSearches = freezed,Object? theme = freezed,Object? locale = freezed,Object? updateAt = freezed,}) {
