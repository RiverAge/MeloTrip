...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,username,maxRate,playlistMode,shuffle,recentSearches,desktopLyricsConfig,theme,themeSeed,locale,updateAt);

@override
String toString() {
  return 'Configuration(username: $username, maxRate: $maxRate, playlistMode: $playlistMode, shuffle: $shuffle, recentSearches: $recentSearches, desktopLyricsConfig: $desktopLyricsConfig, theme: $theme, themeSeed: $themeSeed, locale: $locale, updateAt: $updateAt)';
}
...
/// Create a copy of Configuration
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = freezed,Object? maxRate = freezed,Object? playlistMode = freezed,Object? shuffle = freezed,Object? recentSearches = freezed,Object? desktopLyricsConfig = freezed,Object? theme = freezed,Object? themeSeed = freezed,Object? locale = freezed,Object? updateAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'username')  String? username, @JsonKey(name: 'max_rate')  String? maxRate, @JsonKey(name: 'playlist_mode')  PlaylistMode? playlistMode, @JsonKey(name: 'shuffle')@SqliteBoolConvert()  bool? shuffle, @JsonKey(name: 'recent_searches')  String? recentSearches, @JsonKey(name: 'desktop_lyrics_config')  String? desktopLyricsConfig,  ThemeMode? theme, @JsonKey(name: 'theme_seed')  AppThemeSeed? themeSeed, @LocaleConvert()  Locale? locale, @JsonKey(name: 'update_at')  int? updateAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Configuration() when $default != null:
return $default(_that.username,_that.maxRate,_that.playlistMode,_that.shuffle,_that.recentSearches,_that.desktopLyricsConfig,_that.theme,_that.themeSeed,_that.locale,_that.updateAt);case _:
  return orElse();
...
/// Create a copy of Configuration
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = freezed,Object? maxRate = freezed,Object? playlistMode = freezed,Object? shuffle = freezed,Object? recentSearches = freezed,Object? desktopLyricsConfig = freezed,Object? theme = freezed,Object? themeSeed = freezed,Object? locale = freezed,Object? updateAt = freezed,}) {
