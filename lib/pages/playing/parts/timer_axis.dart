...
class _TimerAxis extends StatelessWidget {
  ...
  _progresssBuilder(
      {Duration? duration, Duration? bufferedPosition, Duration? position}) {
  ...
  _positionBuilder({Duration? duration, Duration? bufferedPosition}) {
    return AsyncStreamBuilder(
        ...
        builder: (_, position, __) => _progresssBuilder(
            duration: duration,
  ...
  _bufferBuilder({Duration? duration}) {
    return AsyncStreamBuilder(
        ...
        builder: (_, bufferedPosition, __) => _positionBuilder(
            duration: duration, bufferedPosition: bufferedPosition));
  }
