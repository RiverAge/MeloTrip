...
class _MusicBarState extends State<MusicBar> {
  ...
  _onOpenPlaylist(BuildContext context) async {
    showModalBottomSheet(
        ...
        builder: (context) => const FractionallySizedBox(
            heightFactor: 0.6, child: _BottomSheetPlaylist()));
  }
  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      Positioned(
          top: 0, left: 0, bottom: 0, right: 0, child: _ColoredContainer()),
      CurrentSongBuilder(builder: (_, current, songs, index, ref) {
        return ListTile(
            ...
            leading: SizedBox(
                ...
                child: current == null
                    ...
                    : ArtworkImage(fit: BoxFit.contain, id: songs[index]?.id)),
            title: current == null
                ? const Text('MeloTrip')
                : Text('${songs[index]?.title} - ${songs[index]?.artist}',
                    ...
                    AsyncStreamBuilder(
                        ...
                        builder: (context, data, ref) {
                          return IconButton(
                              ...
                              onPressed: data.processingState !=
      ...
      Positioned(top: 0, left: 0, right: 0, height: 2, child: _durationBulder())
    ]);
  }
  ...
  _progressBuilder({Duration? duration, Duration? position}) {
    ...
    return LinearProgressIndicator(
        value:
            effectiveDuration == 0 ? 0 : effectivePosition / effectiveDuration);
  }
}
